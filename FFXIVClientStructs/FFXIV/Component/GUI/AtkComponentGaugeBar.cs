...
public unsafe partial struct AtkComponentGaugeBar {
    ...
    [FieldOffset(0x170)] public AtkImageNode* SecondaryOverflowMaxIcon;

    [FieldOffset(0x178)] public AtkResNode* Node178;
    
    [FieldOffset(0x180)] public AtkNineGridNode* BorderNineGridNode; // only found this in the crafting window so far
    [FieldOffset(0x188)] public AtkTextNode* ParameterTextNode; // seems specific to the Parameter Widget

    [FieldOffset(0x190)] public int MinValue;
    [FieldOffset(0x194)] public int MaxValue;

    [FieldOffset(0x198)] public int Unk198;
    [FieldOffset(0x19C)] public short Unk19C;
    [FieldOffset(0x19E)] public short Unk19E;
    ...
    /// If the gauge has a ValueTextNode, that node's text will update accordingly.<br/>
